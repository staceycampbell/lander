...
#define CENTRE(win, line, str) mvwaddstr(win, line, (COLS - sizeof(str)) / 2, str)

static void
Introduction(WINDOW *screen)
{
	werase(screen);
	CENTRE(screen, 2, L0);
	CENTRE(screen, 5, L1);
...
void
InitialiseScreen(WINDOW **init_scr)
{
...
int
MoveLander(WINDOW *screen, double land_y, double land_x)
{
